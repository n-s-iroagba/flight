...
import { Plane, ShieldCheck, Tag, Globe, Smartphone, Search, Crown, Plus, Trash2, CheckSquare, Square, MessageCircle, Radar, ArrowRight, Sparkles, Mail, Headphones } from 'lucide-react';
...
export default function Home() {
  ...
  const handleTrackSearch = (e: React.FormEvent) => {
    ...
    if (ticketSearch.trim()) {
      router.push(`/track?flight=${encodeURIComponent(ticketSearch.trim())}`);
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="bg-slate-dark/95 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-border-slate max-w-5xl mx-auto shadow-2xl relative z-10 text-left">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6 border-b border-border-slate pb-4">
              <div className="flex items-center gap-3">
                ...
                >
                  <Crown className="w-4 h-4 text-text-secondary text-sm" /> Private Jet Charter
                </button>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-text-secondary">
                <a
                  ...
                  className="flex items-center gap-1.5 hover:text-white transition-colors font-mono font-medium"
                >
                  <Mail className="w-4 h-4 text-oxblood" /> booking@swiftwings.online
                </a>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 bg-slate-dark/80 p-6 rounded-2xl border border-slate-800">
          <div className="flex items-center gap-3 text-left w-full md:w-auto">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Track flight radar map and live location with your flight number.</p>
            </div>
          </div>

          <form onSubmit={handleTrackSearch} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
            <input
              type="text"
              placeholder="Enter Flight Number..."
              value={ticketSearch}
              onChange={(e) => setTicketSearch(e.target.value)}
              className="w-full sm:w-64 bg-slate-main border border-slate-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-500 font-mono uppercase"
            />
            <button
              type="submit"
              className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm px-6 py-3 rounded-xl transition-colors whitespace-nowrap flex items-center justify-center gap-1.5 shadow-lg"
            >
      ...
      {/* 24/7 VIP Support & Concierge Banner */}
      <section className="py-12 bg-slate-dark border-t border-border-slate px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto bg-gradient-to-r from-slate-main via-slate-900 to-slate-main border border-border-slate p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 text-left">
            <div className="p-4 bg-oxblood/20 border border-oxblood/40 text-oxblood-bright rounded-2xl shrink-0">
              <Mail className="w-8 h-8" />
            </div>
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-oxblood-bright flex items-center gap-1.5 mb-1">
                <Headphones className="w-3.5 h-3.5" /> 24/7 Executive Support Concierge
              </span>
              <h3 className="text-2xl font-extrabold text-white">Need Assistance with Your Booking?</h3>
              <p className="text-xs sm:text-sm text-text-secondary mt-1">
                Our operations team is ready to assist you with e-tickets, private jet quotes, passport clearance, or flight changes.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0">
            <a
              href="mailto:booking@swiftwings.online"
              className="w-full sm:w-auto bg-oxblood hover:bg-oxblood-bright text-white font-extrabold px-6 py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 text-sm font-mono"
            >
